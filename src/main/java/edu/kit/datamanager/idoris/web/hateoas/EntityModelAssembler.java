 ...
 *
 * @param <T> the entity type, must extend GenericIDORISEntity
 */
public interface EntityModelAssembler<T extends GenericIDORISEntity> extends RepresentationModelAssembler<T, EntityModel<T>> {
