 ...
 *
 * @param <T> the type of entity that was deleted, must extend GenericIDORISEntity
 */
@Getter
@ToString(callSuper = true)
public class EntityDeletedEvent<T extends GenericIDORISEntity> extends AbstractDomainEvent {
