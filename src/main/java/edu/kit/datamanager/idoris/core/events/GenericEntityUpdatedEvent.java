...
public class GenericEntityUpdatedEvent extends AbstractDomainEvent {
    private final Object entity;
    private final String entityType;

    /**
     * Creates a new GenericEntityUpdatedEvent for the given entity.
     *
     * @param entity     the updated entity
     * @param entityType the type identifier for the entity
     */
    public GenericEntityUpdatedEvent(Object entity, String entityType) {
        this.entity = entity;
