 ...
 *
 * @param <T> the type of entity that was updated, must extend GenericIDORISEntity
 */
@Getter
@ToString(callSuper = true)
public class EntityUpdatedEvent<T extends GenericIDORISEntity> extends AbstractDomainEvent {
